...
enum ContainedViewLayoutTransitionCurve {
    case linear
    case easeInOut
    case spring
    case custom(Float, Float, Float, Float)

    static var slide: ContainedViewLayoutTransitionCurve {
...
extension ContainedViewLayoutTransitionCurve {
    ...
    var mediaTimingFunction: CAMediaTimingFunction? {
        ...
        case .spring:
            return nil
        case .custom(let p1, let p2, let p3, let p4):
...
enum ContainedViewLayoutTransition {
    case immediate
...
extension CGRect {
    var ensuredValid: CGRect {
        if !ASIsCGRectValidForLayout(CGRect(origin: CGPoint(), size: size)) {
            return CGRect()
        }
        if !ASIsCGPositionValidForLayout(origin) {
            return CGRect()
        }
        return self
    }
...
extension ContainedViewLayoutTransition {
    func updateFrame(
        node: ASDisplayNode,
        frame: CGRect,
        force: Bool = false,
    ...
    func updateFrameAsPositionAndBounds(
        node: ASDisplayNode,
        frame: CGRect,
        force: Bool = false,
        beginWithCurrentState: Bool = false,
        ...
        if node.frame.equalTo(frame), !force {
            ...
            case .animated(let duration, let curve):
                ...
                node.layer.animateFrame(
                    ...
                    CGRect(
                        origin: CGPoint(
                            x: previousPosition.x - previousBounds.width / 2.0,
                            y: previousPosition.y - previousBounds.height / 2.0
                        ),
    ...
    func updateFrameAdditive(
        ...
        if node.frame.equalTo(frame), !force {
            ...
            case .animated:
                ...
                node.frame = frame
                animatePositionAdditive(
                    node: node,
                    offset: CGPoint(
                        x: previousFrame.minX - frame.minX,
    ...
    func updateFrameAdditiveToCenter(
        node: ASDisplayNode,
        frame: CGRect,
        force: Bool = false,
        completion: ((Bool) -> Void)? = nil
        ...
        if node.frame.equalTo(frame), !force {
            ...
            case .animated:
                ...
                animatePositionAdditive(
                    node: node,
                    offset: CGPoint(
                        x: previousCenter.x - frame.midX,
                        y: previousCenter.y - frame.midY
                    )
                )
            }
        }
    ...
    func animatePosition(
        ...
        if !additive, node.position.equalTo(position) {
            ...
            case .animated(let duration, let curve):
                node.layer.animatePosition(
                    from: additive ? CGPoint() : node.position,
                    to: position,
                    duration: duration,
                    timingFunction: curve.timingFunction,
                    mediaTimingFunction: curve.mediaTimingFunction,
    ...
    func animateOffsetAdditive(node: ASDisplayNode, offset: CGFloat) {
        ...
        case .immediate:
            break
        case .animated(let duration, let curve):
            node.layer.animateBoundsOriginYAdditive(
                from: offset,
                to: 0.0,
                duration: duration,
                timingFunction: curve.timingFunction,
    ...
    func animateHorizontalOffsetAdditive(
        node: ASDisplayNode,
        offset: CGFloat,
        completion: (() -> Void)? = nil
    ) {
        ...
        case .immediate:
            break
        case .animated(let duration, let curve):
            node.layer.animateBoundsOriginXAdditive(
                from: offset,
                to: 0.0,
                duration: duration,
                timingFunction: curve.timingFunction,
    ...
    func animateOffsetAdditive(layer: CALayer, offset: CGFloat, completion: (() -> Void)? = nil) {
        ...
        case .immediate:
            completion?()
        case .animated(let duration, let curve):
            layer.animateBoundsOriginYAdditive(
                from: offset,
                to: 0.0,
                duration: duration,
                timingFunction: curve.timingFunction,
    ...
    func updateCornerRadius(
        ...
        case .animated(let duration, let curve):
            ...
            node.cornerRadius = cornerRadius
            node.layer.animate(
                from: NSNumber(value: Float(previousCornerRadius)),
    ...
    func updateSublayerTransformScale(
        node: ASDisplayNode,
        scale: CGFloat,
        delay: Double = 0.0,
        completion: ((Bool) -> Void)? = nil
        ...
        case .animated(let duration, let curve):
            node.layer.sublayerTransform = CATransform3DMakeScale(scale, scale, 1.0)
            node.layer.animate(
                from: NSValue(caTransform3D: t),
                to: NSValue(caTransform3D: node.layer.sublayerTransform),
    ...
    func updateSublayerTransformScaleAdditive(
        node: ASDisplayNode,
        scale: CGFloat,
        completion: ((Bool) -> Void)? = nil
    ) {
        ...
        case .animated(let duration, let curve):
            ...
            node.layer.sublayerTransform = CATransform3DMakeScale(scale, scale, 1.0)
            node.layer.animate(
                from: -(scale - currentScale) as NSNumber,
                to: 0.0 as NSNumber,
    ...
    func updateSublayerTransformScaleAndOffset(
        ...
        if abs(currentScale - scale) <= CGFloat.ulpOfOne,
           abs(currentOffset.x - offset.x) <= CGFloat.ulpOfOne,
           abs(currentOffset.y - offset.y) <= CGFloat.ulpOfOne
        {
            if let completion = completion {
                completion(true)
            }
        ...
        let transform = CATransform3DTranslate(
    ...
    func updateSublayerTransformScale(
        ...
        updateSublayerTransformScale(
            layer: node.layer,
            scale: scale,
            beginWithCurrentState: beginWithCurrentState,
            completion: completion
        )
    }
    ...
    func updateSublayerTransformScale(
        ...
        case .animated(let duration, let curve):
            ...
            layer.animate(
                from: NSValue(caTransform3D: initialTransform),
                to: NSValue(caTransform3D: layer.sublayerTransform),
                keyPath: "sublayerTransform",
                timingFunction: curve.timingFunction,
                duration: duration,
                delay: 0.0,
    ...
    func updateTransformScale(
        ...
        case .animated(let duration, let curve):
            ...
            node.layer.animate(
                from: NSValue(caTransform3D: t),
                to: NSValue(caTransform3D: node.layer.transform),
                keyPath: "transform",
                timingFunction: curve.timingFunction,
                duration: duration,
                delay: 0.0,
    ...
    func updateSublayerTransformOffset(
        layer: CALayer,
        offset: CGPoint,
        completion: ((Bool) -> Void)? = nil
    ) {
    ...
    func updateTransformRotationAndScale(
        view: UIView,
        angle: CGFloat,
        scale: CGPoint,
        beginWithCurrentState: Bool = false,
        ...
        case .immediate:
            view.layer.transform = CATransform3DRotate(
                CATransform3DMakeScale(scale.x, scale.y, 1.0),
                angle,
                0.0,
                0.0,
                1.0
    ...
    func animateView(_ f: @escaping () -> Void, completion: ((Bool) -> Void)? = nil) {
        ...
        case .animated(let duration, let curve):
            UIView.animate(
                ...
                delay: 0.0,
                options: curve.viewAnimationOptions,
                animations: {
                    f()
                },
                completion: completion
