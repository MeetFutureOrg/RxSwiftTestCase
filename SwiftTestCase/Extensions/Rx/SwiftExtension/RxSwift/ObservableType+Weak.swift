...
public extension ObservableType {
     ...
     */
    private func weakify<Object: AnyObject, Input>(
        _ obj: Object,
    ...
    private func weakify<Object: AnyObject>(
        _ obj: Object,
        method: ((Object) -> () -> Void)?
    ) -> (() -> Void) {
        return { [weak obj] in
    ...
    func subscribe<Object: AnyObject>(
        weak obj: Object,
        _ on: @escaping (Object) -> (Event<Element>) -> Void
    ) -> Disposable {
    ...
    /**
     ...
     - returns: Subscription object used to unsubscribe from the observable sequence.
     */
    func subscribeNext<Object: AnyObject>(
        weak obj: Object,
        _ onNext: @escaping (Object) -> (Element) -> Void
    ) -> Disposable {
    ...
    /**
     ...
     - returns: Subscription object used to unsubscribe from the observable sequence.
     */
    func subscribeError<Object: AnyObject>(
        weak obj: Object,
        _ onError: @escaping (Object) -> (Error) -> Void
    ) -> Disposable {
    ...
    /**
     ...
     - returns: Subscription object used to unsubscribe from the observable sequence.
     */
    func subscribeCompleted<Object: AnyObject>(
        weak obj: Object,
        _ onCompleted: @escaping (Object) -> () -> Void
    ) -> Disposable {
