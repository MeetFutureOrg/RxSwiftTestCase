...
public extension ObservableType where Element == Bool {
    ...
    static func and<Collection: Swift.Collection>(_ collection: Collection)
        -> Maybe<Element> where Collection.Element: ObservableType,
    ...
    /**
     ...
     Use `asSingle()` or `asObservable()` to convert to your requirements.
     */
    static func and<Observable: ObservableType>(_ sources: Observable ...) -> Maybe<Element>
