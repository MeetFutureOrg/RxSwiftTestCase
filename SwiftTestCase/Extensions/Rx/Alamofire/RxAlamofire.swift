...
{
    return Alamofire.Session.default.rx.response(
        method,
        url,
        parameters: parameters,
        encoding: encoding,
...
{
    return Alamofire.Session.default.rx.responseDecodable(
        method,
        url,
        parameters: parameters,
        encoding: encoding,
...
public func decodable<T: Decodable>(
    ...
    -> Observable<T>
{
    return Alamofire.Session.default.rx.decodable(
        method,
        url,
        parameters: parameters,
        encoding: encoding,
...
public func download(
    ...
    return Alamofire.Session.default.rx.download(
        urlRequest,
        interceptor: interceptor,
        to: destination
    )
...
public extension Reactive where Base: Alamofire.Session {
     ...
     */
    internal func request<R: RxAlamofireRequest>(_ createRequest: @escaping (
        Alamofire
            .Session
    ) throws -> R) -> Observable<R> {
...
public extension ObservableType where Element == DataRequest {
    ...
    func validate<S: Sequence>(contentType acceptableContentTypes: S) -> Observable<Element>
...
public extension Reactive where Base: DataRequest {
     ...
     */
    func responseResult<T: DataResponseSerializerProtocol>(
