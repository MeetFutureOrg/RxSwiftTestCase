...
public class TwicketSegmentedControl: UIControl {
    ...
    public var defaultTextColor: UIColor = Palette.defaultTextColor {
        didSet {
            updateLabelsColor(with: defaultTextColor, selected: false)
        }
    }

    public var highlightTextColor: UIColor = Palette.highlightTextColor {
        didSet {
            updateLabelsColor(with: highlightTextColor, selected: true)
        }
    }

    public var segmentsBackgroundColor: UIColor = Palette.segmentedControlBackgroundColor {
        didSet {
            backgroundView.backgroundColor = segmentsBackgroundColor
        }
    }

    public var sliderBackgroundColor: UIColor = Palette.sliderColor {
        didSet {
    ...
    public var isSliderShadowHidden: Bool = false {
        didSet {
    ...
    private lazy var selectedContainerView = UIView()
    ...
    private func updateShadow(with _: UIColor, hidden: Bool) {
        if hidden {
    ...
    private func moveToNearestPoint(
        basedOn gesture: UIGestureRecognizer,
